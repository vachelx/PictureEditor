...
public class EditUtils {
    ...
    public static void fitFrameCenter(RectF win, RectF frame) {
    ...
    public static EditState fitHoming(RectF win, RectF frame) {
        EditState dHoming = new EditState(0, 0, 1, 0);
    ...
    public static EditState fitHoming(RectF win, RectF frame, float centerX, float centerY) {
        EditState dHoming = new EditState(0, 0, 1, 0);
    ...
    public static EditState fitHoming(RectF win, RectF frame, boolean isJustInner) {
        EditState dHoming = new EditState(0, 0, 1, 0);
    ...
    public static EditState fillHoming(RectF win, RectF frame) {
        EditState dHoming = new EditState(0, 0, 1, 0);
        if (frame.contains(win)) {
            // 不需要Fill
            return dHoming;
    ...
    public static EditState fillHoming(RectF win, RectF frame, float pivotX, float pivotY) {
        EditState dHoming = new EditState(0, 0, 1, 0);
        if (frame.contains(win)) {
            // 不需要Fill
            return dHoming;
    ...
    public static EditState fill(RectF win, RectF frame) {
        EditState dHoming = new EditState(0, 0, 1, 0);
